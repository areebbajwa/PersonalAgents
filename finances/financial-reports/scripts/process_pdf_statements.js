...
async function main() {
  ...
  const pdfDir = '/Volumes/ExtremeSSD/PersonalAgents/PersonalAgents/finances/financial-reports/data/downloaded_statements';
  const dbPath = '/Volumes/ExtremeSSD/PersonalAgents/PersonalAgents/finances/financial-reports/data/categorized_transactions.db';

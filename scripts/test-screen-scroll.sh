...
screen -S scroll-test bash -c '
    ...
    echo "1. Screen command shortcuts (most reliable):"
    echo "   - Ctrl-a k: Scroll UP by page (auto-exits copy mode)"
    echo "   - Ctrl-a j: Scroll DOWN by page (auto-exits copy mode)"
    echo "2. Alternative (if your terminal supports):"
    ...
    echo "4. Try pressing Ctrl-a k multiple times quickly for rapid scrolling"
